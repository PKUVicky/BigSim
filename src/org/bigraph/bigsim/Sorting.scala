...
class Sorting {
  ...
  var ctrlSortMap: Map[String, String] = Map(); // Map[controlName, sortName]
  ...
  def init(file: String): Unit = {
    try {
      var sortingInfo: Elem = XML.load(file);
...
object testSorting {
  def main(args: Array[String]) {
    ...
    // test init
    var fileName: String = "sortingFile/SortingConstraint.xml";
