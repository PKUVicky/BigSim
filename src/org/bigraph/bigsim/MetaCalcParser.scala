...
object testTermParser {
  ...
  def main(args: Array[String]) {
    ...
    println(QueryParser.parse("5 != matches(n)"))

    println(QueryParser.parse("5 > size()"))
    println(QueryParser.parse("size() > 5"))
    println(QueryParser.parse("size() > $pred->size()"))
    println(QueryParser.parse("$pred->empty() || size() > $pred->size()"))

    q = QueryParser.parse("5 > 3 && 3 > 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 < 3 && 3 > 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 3 && 3 < 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 3 && 3 > 1 && 2 < 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 3 && 3 > 1 && 1 < 2");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 3 && 1 > 3 && 1 < 2");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 3 || 3 > 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 < 3 || 3 > 1");
    ...
    q = QueryParser.parse("5 < 3 || 3 < 1 || 2 < 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 5 && 3 > 1 || 1 < 2");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("1 < 2 || 3 > 5 && 3 > 1");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 > 3 || 3 > 1 && 1 < 2");
    println(q + ", q.check: " + q.check(null));
    q = QueryParser.parse("5 < 3 || 3 < 1 && 1 > 2");
